...
(equ? (make-scheme-number 5) (make-scheme-number 3)) ; #f

(equ? (make-rational 1 2) (make-rational 1 2)) ; #t
(equ? (make-rational 2 4) (make-rational 1 2)) ; #t (reduced to same form)
(equ? (make-rational 1 2) (make-rational 1 3)) ; #f
